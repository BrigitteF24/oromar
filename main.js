...
window.registrarCliente = async function (event) {
  ...
  try {
    ...
    const { error } = await obtenerBaseDatos().rpc('registrar_cliente_web', {
      p_nombres: nombres,
...
window.enviarReserva = async function (event) {
  ...
  try {
    ...
    const { error } = await obtenerBaseDatos().rpc('crear_reserva_web', {
      p_nombres: nombres,
      p_apellidos: apellidos,
      p_telefono: telefono,
      p_correo: correo,
...
window.guardarComentario = async function (event) {
  ...
  try {
    ...
    const { error } = await obtenerBaseDatos().rpc('crear_comentario_web', {
      p_nombres: nombres,
      p_apellidos: apellidos,
      p_telefono: telefono,
      p_correo: correo,
...
window.enviarContacto = async function (event) {
  ...
  try {
    ...
    const { error } = await obtenerBaseDatos().rpc('crear_contacto_web', {
      p_nombres: nombres,
      p_apellidos: apellidos,
      p_telefono: telefono,
      p_correo: correo,
